...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            test_mse, test_mae = self.test(test_data, test_loader, criterion)
            ...
            f = open(folder_path + "result_long_term_forecast_{}_{}.txt".format(self.args.features, self.args.window_size), 'a')
            f.write('train_loss:{}, vali_loss:{}, test_mse:{}, test_mae:{}'.format(train_loss, vali_loss, test_mse, test_mae))
            f.write('\n')
            f.write('\n')
            f.close()
