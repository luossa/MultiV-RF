...
if __name__ == '__main__':
    ...
    #timsnet
    parser.add_argument("--timesnet_k", type=int, default=2, help="timesnet k")
    ...
    #classification
    parser.add_argument('--num_class', type=int, default=5, help='the number of classfication')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = 'dataset:{}\tseq_len:{}\tlabel_len:{}\tpred_len:{}\ttimesnet_K:{}\tlora_alpha:{}\tlora_dropout:{}\ttask_w:{}\tfeature_w:{}\toutput_w:{},record_time:{}'.format(
                args.data,
                args.seq_len,
                args.label_len,
                args.pred_len,
